...
void Renderer::Utility::CreateConstantBuffer(ComPtr<ID3D12Device5>& device, ComPtr<ID3D12GraphicsCommandList>& commandList, UINT64 buffersize, ComPtr<ID3D12Resource>& buffer, void** pBufferData)
{
	ThrowIfFailed(
