...
namespace Renderer {
	...
	public:
		...
		void InitializeUavSrv(UINT uavCount, UINT srvCount, UINT cbCount, std::vector<D3D12_STATIC_SAMPLER_DESC>& sampler);
		...
		void InitializeUAV(UINT uavCount, UINT cbCount, std::vector<D3D12_STATIC_SAMPLER_DESC>& sampler);
